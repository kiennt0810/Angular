export const MENU = [
  ...
  {
    id: '22',
    name: 'Quản lý tiếp khách quốc tế',
    icon: './content/images/layout/sidebar/global-file-svgrepo-com.svg',
  ...
  {
    id: '23',
    name: 'Quản lý hoạt động ngoại giao đoàn',
    icon: './content/images/layout/sidebar/activity-svgrepo-com.svg',
  ...
  },
  {
    ...
    leaves: [
      ...
      },
      {
        id: '40',
        parentId: '29',
        name: 'Danh mục loại hộ chiếu của Việt Nam',
        icon: './content/images/layout/sidebar/passport-free.svg',
        path: '/quanlydanhmuc/loaihochieu',
        authorities: ['02002'],
        active: false,
        leaves: null,  
      },
