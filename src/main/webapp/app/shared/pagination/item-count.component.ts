...
@Component({
  ...
  template: ` <div jhiTranslate="global.item-count" [translateValues]="{ nameModule: nameModule, total: total }"></div> `,
})
export class ItemCountComponent {
   ...
   */
  @Input() set params(params: { page?: number; totalItems?: number; itemsPerPage?: number ; nameModule?: string;}) {
