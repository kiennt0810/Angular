...
typeof global != 'undefined' && (global.numeric = numeric),
  ...
  (numeric.prettyPrint = function (t) {
    function n(e) {
      ...
      if (isFinite(e)) {
        ...
        return (
          parseFloat(i) === 10 && (t++, (r = 1), (i = r.toPrecision(numeric.precision))), parseFloat(i).toString() + 'e' + t.toString()
        );
      }
      return 'Infinity';
    }
  ...
  (numeric.dim = function (t) {
    var n, r;
    if (typeof t == 'object')
      return (n = t[0]), typeof n == 'object' ? ((r = n[0]), typeof r == 'object' ? numeric._dim(t) : [t.length, n.length]) : [t.length];
    return [];
  }),
    ...
    if (typeof s != 'string') {
      ...
      for (u in numeric)
        numeric.hasOwnProperty(u) &&
          (t.indexOf(u) >= 0 || n.indexOf(u) >= 0 || r.indexOf(u) >= 0 || i.indexOf(u) >= 0) &&
          u.length > 1 &&
          (s += 'var ' + u + ' = numeric.' + u + ';\n');
    }
    return Function(
  ...
  (numeric.T.prototype.setRow = function (t, n) {
    var r = this.x,
      ...
      o = n.y;
    return (
      (r[t] = s), o ? (i || ((i = numeric.rep(numeric.dim(r), 0)), (this.y = i)), (i[t] = o)) : i && (i = numeric.rep([s.length], 0)), this
    );
  }),
        ...
        (w = -m - b),
          ...
          S >= 0
            ? (w < 0 ? (x = -0.5 * (w - A(S))) : (x = -0.5 * (w + A(S))),
              (k = (m - x) * (m - x) + g * g),
              (L = y * y + (b - x) * (b - x)),
              k > L ? ((k = A(k)), (N = (m - x) / k), (C = g / k)) : ((L = A(L)), (N = y / L), (C = (b - x) / L)),
              (p = new s([
                [C, -N],
                [N, C],
              ])),
            ...
            : ((x = -0.5 * w),
              ...
              (L = y * y + (b - x) * (b - x)),
              k > L
                ? ((k = A(k + T * T)), (N = (m - x) / k), (C = g / k), (x = 0), (T /= k))
                : ((L = A(L + T * T)), (N = y / L), (C = (b - x) / L), (x = T / L), (T = 0)),
              (p = new s(
                [
                  [C, -N],
                  [N, C],
  ...
  (numeric.ccsLUP1 = function (t, n) {
    ...
    for (d = 0; d < r; ++d) {
      ...
      C(h[d]) < n * b && ((v = k[d]), (b = k[w]), (k[d] = b), (L[b] = d), (k[w] = v), (L[v] = w), (b = h[d]), (h[d] = h[w]), (h[w] = b)),
        (b = o[d]),
        (w = f[d]),
        (S = h[d]),
        (u[b] = k[d]),
  ...
  (numeric.ccsLUP0 = function (t, n) {
    ...
    for (d = 0; d < r; ++d) {
      ...
      C(h[k[d]]) < n * b && ((v = k[d]), (b = k[w]), (k[d] = b), (L[b] = d), (k[w] = v), (L[v] = w)),
        (b = o[d]),
        (w = f[d]),
        (S = h[k[d]]),
        (u[b] = k[d]),
  ...
  (function () {
    ...
    for (k in numeric.ops2)
      isFinite(eval('1' + numeric.ops2[k] + '0')) ? (A = '[Y[0],Y[1],numeric.' + k + '(X,Y[2])]') : (A = 'NaN'),
        ...
        isFinite(eval('1' + numeric.ops2[k] + '0')) && isFinite(eval('0' + numeric.ops2[k] + '1'))
    ...
    for (c = 0; c !== f; ++c) {
      ...
      for (h = 0; h !== l; h++) {
        h > 0 && y[h] * g[h] < 0 && E.push(i[h]),
          ...
          (k = 3 * (x + S + 2 * (T - N))),
          L <= 0
            ? ((_ = C / k), _ > i[h] && _ < i[h + 1] ? (M = [i[h], _, i[h + 1]]) : (M = [i[h], i[h + 1]]))
            : ((_ = (C - F(L)) / k),
              (D = (C + F(L)) / k),
              (M = [i[h]]),
  ...
  (numeric.spline = function (t, n, r, i) {
    ...
    else for (f = d.length - 1; f !== -1; --f) d[f] = numeric.cLUsolve(numeric.cLU(p), o[f]);
  ...
  (numeric.dopri = function (t, n, r, i, s, o, u) {
    ...
    var a = [t],
      ...
      T = [
        0.10013431883002395, 0, 0.3918321794184259, -0.02982460176594817, 0.05893268337240795, -0.04497888809104361, 0.023904308236133973,
      ],
      N = [0.2, 0.3, 0.8, 8 / 9, 1, 1],
      C = [-71 / 57600, 0, 71 / 16695, -71 / 1920, 17253 / 339200, -22 / 525, 0.025],
      k = 0,
      L,
      A,
      O = (n - t) / 10,
        ...
        if (R($)) {
          ...
          for (;;) {
            ...
            (K = J._at(Y, k - 1)),
              ...
              (tt = z(U(X, 0), U(0, nt))),
              R(tt)
                ? ((G = Y), (V = nt), ($ = tt), (st = 1), rt === -1 ? (it *= 0.5) : (it = 1), (rt = -1))
                : ((Q = Y), (X = nt), (it = 1), rt === 1 ? (st *= 0.5) : (st = 1), (rt = 1));
          }
          return (
            (P = J._at(0.5 * (t + Y), k - 1)),
            (J.f[k] = i(Y, K)),
  ...
  (function (e, t, n, r, i, s, o) {
    ...
    (t.seedrandom = function (c, h) {
      var p = [],
        d;
      return (
        (c = f(a(h ? [c, e] : arguments.length ? c : [new Date().getTime(), e, window], 3), p)),
        (d = new u(p)),
        f(d.S, e),
        (t.random = function () {
          var t = d.g(r),
  ...
  (function (e) {
    ...
    function u(e, r, i, s, u, a) {
      ...
      return (
        ...
        { solution: n(m), value: n(d), unconstrained_solution: n(r), iterations: n(y), iact: n(v), message: b }
      );
    }
    e.solveQP = u;
  })(numeric),
  (numeric.svd = function (t) {
    function g(e, t) {
      return (
        (e = Math.abs(e)), (t = Math.abs(t)), e > t ? e * Math.sqrt(1 + (t * t) / e / e) : t == 0 ? e : t * Math.sqrt(1 + (e * e) / t / t)
      );
    }
    var n,
      r = numeric.epsilon,
